...
public class MainActivity extends AppCompatActivity {
    ...
    private  String [] mDrawerTitle = {"Iron Man", "Captain America", "Hawkeye", "Hulk", "Thor", "Vision", "Scarlet Witch", "Star-Lord", "Dr.Strange", "Black Panther", "Spider-Man", "Thanos"};
